  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
        ...
        {activePanel && (
          <div className="panel-appear">
            <Win95Window
              ...
              dsTheme={dsTheme}
            >
              {activePanel === 'turntable' && <TurntablePanel dsTheme={dsTheme} roomId={roomId} />}
        ...
        {chatOpen && <ChatPanel onClose={() => setChatOpen(false)} dsTheme={dsTheme} roomId={roomId} />}
      </div>
      ...
      <div style={{
        ...
        <button
          onClick={copyLink}
          title={copyMsg || `Room: ${roomId} — click to copy link`}
          style={{
            ...taskBtnBase,
